 ...
 * 扩展的textView
 */
public class TextViewExpand extends RelativeLayout {
...
//        defaultLinePadding = dip2px(context, 16);
    ...
    private void getAttr(AttributeSet attrs) {
        TypedArray typedArray = mContext.obtainStyledAttributes(attrs, R.styleable.TextViewExpand);

        ////////设置文字或者图片资源////////
        leftIconRes = typedArray.getDrawable(R.styleable.TextViewExpand_eLeftIconRes);
        rightIconRes = typedArray.getDrawable(R.styleable.TextViewExpand_eRightIconRes);
        rightCheckBoxBg = typedArray.getDrawable(R.styleable.TextViewExpand_eRightCheckBoxRes);

        leftTextString = typedArray.getString(R.styleable.TextViewExpand_eLeftTextString);
        centerTextString = typedArray.getString(R.styleable.TextViewExpand_eCenterTextString);
        rightTextString = typedArray.getString(R.styleable.TextViewExpand_eRightTextString);

        rightTextStringRightIconRes = typedArray.getDrawable(R.styleable.TextViewExpand_eRightTextStringRightIconRes);
        rightTextStringRightIconPadding = typedArray.getDimensionPixelSize(R.styleable.TextViewExpand_eRightTextStringRightIconResPadding, dip2px(mContext, 5));

        leftTopTextString = typedArray.getString(R.styleable.TextViewExpand_eLeftTopTextString);
        leftBottomTextString = typedArray.getString(R.styleable.TextViewExpand_eLeftBottomTextString);
        leftBottomTextString2 = typedArray.getString(R.styleable.TextViewExpand_eLeftBottomTextString2);

        showCheckBox = typedArray.getBoolean(R.styleable.TextViewExpand_eRightCheckBoxShow, false);
        isChecked = typedArray.getBoolean(R.styleable.TextViewExpand_eIsChecked, false);
        useRipple = typedArray.getBoolean(R.styleable.TextViewExpand_eUseRipple, false);

        lineType = typedArray.getInt(R.styleable.TextViewExpand_eLineShow, DEFAULT);

        /////////设置view的边距////////
        centerSpaceHeight = typedArray.getDimensionPixelSize(R.styleable.TextViewExpand_eCenterSpaceHeight, centerSpaceHeight);

        bothLineWidth = typedArray.getDimensionPixelSize(R.styleable.TextViewExpand_eBothLineWidth, dip2px(mContext, 0.5f));
        topLineWidth = typedArray.getDimensionPixelSize(R.styleable.TextViewExpand_eTopLineWidth, dip2px(mContext, 0.5f));
        bottomLineWidth = typedArray.getDimensionPixelSize(R.styleable.TextViewExpand_eBottomLineWidth, dip2px(mContext, 0.5f));

        lineColor = typedArray.getColor(R.styleable.TextViewExpand_eLineColor, lineColor);

        topLineMargin = typedArray.getDimensionPixelSize(R.styleable.TextViewExpand_eTopLineMargin, defaultLinePadding);
        bottomLineMargin = typedArray.getDimensionPixelSize(R.styleable.TextViewExpand_eBottomLineMargin, defaultLinePadding);
        bothLineMargin = typedArray.getDimensionPixelSize(R.styleable.TextViewExpand_eBothLineMargin, defaultLinePadding);

        leftIconMarginLeft = typedArray.getDimensionPixelSize(R.styleable.TextViewExpand_eLeftIconMarginLeft, defaultPadding);
        leftTVMarginLeft = typedArray.getDimensionPixelSize(R.styleable.TextViewExpand_eLeftTextMarginLeft, defaultPadding);

        leftTopMarginLeft = typedArray.getDimensionPixelSize(R.styleable.TextViewExpand_eLeftTopTextMarginLeft, defaultPadding);
        leftBottomMarginLeft = typedArray.getDimensionPixelSize(R.styleable.TextViewExpand_eLeftBottomTextMarginLeft, defaultPadding);
        leftBottomMarginLeft2 = typedArray.getDimensionPixelSize(R.styleable.TextViewExpand_eLeftBottomTextMarginLeft2, defaultPadding);
        rightTVMarginRight = typedArray.getDimensionPixelSize(R.styleable.TextViewExpand_eRightTextMarginRight, defaultPadding);
        rightIconMarginRight = typedArray.getDimensionPixelSize(R.styleable.TextViewExpand_eRightIconMarginRight, defaultPadding);
        rightCheckBoxMarginRight = typedArray.getDimensionPixelSize(R.styleable.TextViewExpand_eRightCheckBoxMarginRight, defaultPadding);
        //////设置字体颜色////////
        backgroundColor = typedArray.getColor(R.styleable.TextViewExpand_eBackgroundColor, defaultBgColor);
        leftTVColor = typedArray.getColor(R.styleable.TextViewExpand_eLeftTextColor, defaultColor);
        leftTopTVColor = typedArray.getColor(R.styleable.TextViewExpand_eLeftTopTextColor, defaultColor);
        leftBottomTVColor = typedArray.getColor(R.styleable.TextViewExpand_eLeftBottomTextColor, defaultColor);
        leftBottomTVColor2 = typedArray.getColor(R.styleable.TextViewExpand_eLeftBottomTextColor2, defaultColor);
        rightTVColor = typedArray.getColor(R.styleable.TextViewExpand_eRightTextColor, defaultColor);
        centerTVColor = typedArray.getColor(R.styleable.TextViewExpand_eCenterTextColor, defaultColor);
        //////设置字体大小////////
        leftTVSize = typedArray.getDimensionPixelSize(R.styleable.TextViewExpand_eLeftTextSize, defaultSize);
        leftTopTVSize = typedArray.getDimensionPixelSize(R.styleable.TextViewExpand_eLeftTopTextSize, defaultSize);
        leftBottomTVSize = typedArray.getDimensionPixelSize(R.styleable.TextViewExpand_eLeftBottomTextSize, defaultSize);
        leftBottomTVSize2 = typedArray.getDimensionPixelSize(R.styleable.TextViewExpand_eLeftBottomTextSize2, defaultSize);
        rightTVSize = typedArray.getDimensionPixelSize(R.styleable.TextViewExpand_eRightTextSize, defaultSize);
        centerTVSize = typedArray.getDimensionPixelSize(R.styleable.TextViewExpand_eCenterTextSize, defaultSize);

        ///////设置textView的属性///////////SuperTextViewxEms
        isSingLines = typedArray.getBoolean(R.styleable.TextViewExpand_eIsSingLines, isSingLines);
        maxLines = typedArray.getInt(R.styleable.TextViewExpand_eMaxLines, maxLines);
        maxEms = typedArray.getInt(R.styleable.TextViewExpand_eMaxEms, maxEms);

        leftIconWidth = typedArray.getDimensionPixelSize(R.styleable.TextViewExpand_eLeftIconWidth, 0);
        leftIconHeight = typedArray.getDimensionPixelSize(R.styleable.TextViewExpand_eLeftIconHeight, 0);

        rightIconWidth = typedArray.getDimensionPixelSize(R.styleable.TextViewExpand_eRightIconWidth, 0);
        rightIconHeight = typedArray.getDimensionPixelSize(R.styleable.TextViewExpand_eRightIconHeight, 0);

        mLeftTopViewIsClickable = typedArray.getBoolean(R.styleable.TextViewExpand_eLeftTopViewIsClickable, false);
        mLeftBottomViewIsClickable = typedArray.getBoolean(R.styleable.TextViewExpand_eLeftBottomViewIsClickable, false);
        mLeftBottomView2IsClickable = typedArray.getBoolean(R.styleable.TextViewExpand_eLeftBottomView2IsClickable, false);

        mBackground_drawable = typedArray.getDrawable(R.styleable.TextViewExpand_eBackgroundDrawableRes);
     ...
     * @return 返回对象
     */
    public TextViewExpand setLeftIcon(Drawable leftIcon) {
     ...
     * @return 返回对象
     */
    public TextViewExpand setRightIcon(Drawable rightIcon) {
     ...
     * @return 返回对象
     */
    public TextViewExpand setLeftString(String leftString) {
     ...
     * @return 返回对象
     */
    public TextViewExpand setLeftTopString(String leftTopString) {
     ...
     * @return 返回对象
     */
    public TextViewExpand setLeftBottomString(String leftBottomString) {
     ...
     * @return 返回对象
     */
    public TextViewExpand setLeftBottomString2(String leftBottomString2) {
     ...
     * @return 返回对象
     */
    public TextViewExpand setRightString(String rightString) {
     ...
     * @return
     */
    public TextViewExpand setRightString(String rightString, Drawable drawable, int drawablePadding) {
        rightTextString = rightString;
     ...
     * @return 返回对象
     */
    public TextViewExpand setCenterString(String centerString) {
     ...
     * @return 返回值
     */
    public TextViewExpand setCbChecked(boolean checked) {
        isChecked = checked;
     ...
     * @return 返回对象
     */
    public TextViewExpand setCbBackground(Drawable drawable) {
     ...
     * @return 返回对象
     */
    public TextViewExpand setLeftTVColor(int textColor) {
     ...
     * @return 返回对象
     */
    public TextViewExpand setRightTVColor(int textColor) {
     ...
     * @return 返回对象
     */
    public TextViewExpand setLeftTopTVColor(int textColor) {
     ...
     * @return 返回对象
     */
    public TextViewExpand setLeftBottomTVColor(int textColor) {
     ...
     * @return 返回对象
     */
    public TextViewExpand setLeftBottomTVColor2(int textColor) {
     ...
     * @return 返回对象
     */
    public TextViewExpand setOnSuperTextViewClickListener(OnSuperTextViewClickListener listener) {
     ...
     * @return 返回
     */
    public TextViewExpand setLeftTopViewIsClickable(boolean isClickable) {
        if (isClickable) {
            if (leftTopTV != null) {
                leftTopTV.setOnClickListener(new OnClickListener() {
                    @Override
     ...
     * @return 返回
     */
    public TextViewExpand setLeftBottomViewIsClickable(boolean isClickable) {
        if (isClickable) {
            if (leftBottomTV != null) {
                leftBottomTV.setOnClickListener(new OnClickListener() {
                    @Override
     ...
     * @return 返回
     */
    public TextViewExpand setLeftBottomView2IsClickable(boolean isClickable) {
        if (isClickable) {
            if (leftBottomTV2 != null) {
                leftBottomTV2.setOnClickListener(new OnClickListener() {
                    @Override
